...
from email_processor.imap.auth import get_imap_password, clear_passwords, IMAPAuth
...
class TestIMAPPassword(unittest.TestCase):
    ...
    def test_imap_auth_get_password(self):
        ...
        with patch("email_processor.imap.auth.keyring.get_password", return_value="stored_password"):
