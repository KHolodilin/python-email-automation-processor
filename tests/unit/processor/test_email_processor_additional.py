...
class TestEmailProcessorAdditional(unittest.TestCase):
    ...
    def test_process_email_header_parse_error(self):
        ...
        with patch("email_processor.processor.email_processor.message_from_bytes", side_effect=Exception("Parse error")):
            result = self.processor._process_email(mock_mail, b"1", {}, False)
    ...
    def test_process_email_processed_uid_save_error(self):
        ...
        with patch("email_processor.processor.email_processor.save_processed_uid_for_day", side_effect=Exception("Save error")):
            result = self.processor._process_email(mock_mail, b"1", {}, False)
            self.assertEqual(result, "error")
    ...
    def test_process_email_archive_error(self):
        ...
        with patch("email_processor.processor.email_processor.archive_message", side_effect=Exception("Archive error")):
            result = self.processor._process_email(mock_mail, b"1", {}, False)
    ...
    def test_process_email_message_walk_error(self):
        ...
        with patch("email_processor.processor.email_processor.message_from_bytes", side_effect=[
    ...
    def test_process_file_stats_collection(self):
        ...
        with patch("email_processor.processor.email_processor.get_imap_password", return_value="password"):
            with patch("email_processor.processor.email_processor.imap_connect", return_value=mock_mail):
